...
def generate_quiz_prompt(transcript: str) -> str:
    prompt = f"generate 1 short multiple choice quiz question about ({transcript}) separated by Capital letters and parentheses, without any parentheses in the body. Indicate the correct answer at the bottom using a letter."
    return prompt
